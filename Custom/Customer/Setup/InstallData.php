...
class InstallData implements \Magento\Framework\Setup\InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $eavSetup->removeAttribute(Customer::ENTITY, "business_about");
        ...
        'hear_about_us', [
            ...
            $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'city');
            $attribute->setAttributeSetId($attributeSetId);
            $attribute->setAttributeGroupId($attributeGroupId);
            $attribute->setData('used_in_forms', [
                'adminhtml_customer',
            ...
            // Set attribute sets and groups for "city"
            $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'interest');
            $attribute->setAttributeSetId($attributeSetId);
            $attribute->setAttributeGroupId($attributeGroupId);
            $attribute->setData('used_in_forms', [
                'adminhtml_customer',
